...
class BuyDigiGoldPage extends StatefulWidget {
  const BuyDigiGoldPage({super.key});

  @override
  State<BuyDigiGoldPage> createState() => _BuyDigiGoldPageState();
}

class _BuyDigiGoldPageState extends State<BuyDigiGoldPage> {
  void openModal() {
    showDialog(
      context: context,
